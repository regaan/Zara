...
ROTHALYX RE FRAMEWORK v1.0.0 is the first public release of the codebase. It packages the native desktop application, the reverse engineering core, the CLI, the public SDK, the plugin and scripting surfaces, and the cross-platform release pipeline in one repository.
