...
int main(int argc, char** argv) {
    ...
    const auto output_root = std::filesystem::temp_directory_path() / "rothalyx_distributed_auth_smoke";
    ...
    const std::string good_secret = "rothalyx-auth-good";
    const std::string bad_secret = "rothalyx-auth-bad";
